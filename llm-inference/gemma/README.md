...
- **Coordinate:** `sk.ainet.transformers:skainet-transformers-inference-gemma:0.40.1`
...
```kotlin
dependencies {
    implementation("sk.ainet.transformers:skainet-transformers-inference-gemma:0.40.1")
    implementation("sk.ainet.transformers:skainet-transformers-runtime-gemma-iree:0.40.1") // on-device decode
}
```

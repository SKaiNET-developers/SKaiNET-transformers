...
- **Coordinate:** `sk.ainet.transformers:skainet-transformers-inference-gemma:0.39.0`
...
```kotlin
dependencies {
    implementation("sk.ainet.transformers:skainet-transformers-inference-gemma:0.39.0")
    implementation("sk.ainet.transformers:skainet-transformers-runtime-gemma-iree:0.39.0") // on-device decode
}
```

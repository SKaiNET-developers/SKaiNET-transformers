...
* xref:tutorials/getting-started-leaf.adoc[Getting Started with LEAF] — a model-focused walkthrough with a complete semantic-search example.
* xref:explanation/bert-dsl.adoc[BERT Completely Defined in the DSL] — how the encoder behind this API is defined, executed, and exported.
